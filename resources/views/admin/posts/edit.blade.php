<x-app-layout>
    ...
    <div x-data="{ isEvent: {{ old('is_event', $post->is_event) ? 'true' : 'false' }} }">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="event_end_date"
                                id="event_end_date"
                                value="{{ old('event_end_date', optional($post->event_end_date)->format('Y-m-d')) }}"
                                class="mt-1 block w-full rounded-lg border-gray-300
                                    shadow-sm focus:border-indigo-500
                                    focus:ring-indigo-500"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="event_time"
                                id="event_time"
                                value="{{ old('event_time', $post->event_time ? \Carbon\Carbon::parse($post->event_time)->format('H:i') : '') }}"
                                class="mt-1 block w-full rounded-lg border-gray-300
                                    shadow-sm focus:border-indigo-500
                                    focus:ring-indigo-500"
                            >
